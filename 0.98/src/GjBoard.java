...
/* <------ GJBOARD ------>*/
	...
	public GjBoard() {
		super("GjBoard 0.98"); // Il nome dell'applicazione
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if((categoria.isEmpty()) || (appunto.isEmpty()) || (titolo.isEmpty())) {
						...
						else if(core.newText(text) == 7) {
							JOptionPane.showMessageDialog(null, "È accaduto un errore durante la lettura dell'input: assicurarsi di non aver immesso apici (') nell'appunto.");
						}
						else {
							if(core.addTexts()) {
