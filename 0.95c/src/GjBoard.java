...
TODO:
- Aggiungere bottone per esportare gli appunti in un file sotto a "Leggi appunti";
- Aggiungere una tab con la textarea readonly "About", un label con il numero di appunti presenti e il bottone "Elimina database".

TODO per le successive versioni stabili:
- Permettere la modifica di ogni appunto;
- Permettere la singola eliminazione di ogni appunto;
*/
